...
export class HomePage extends Component {
    ...
    createMenu() {
        this.menu = [
            ...
            {label: 'View Source', icon: 'pi pi-fw pi-search', command: () => {window.location = "https://github.com/TheodoreTsg/react-project"}}
        ];
      }
    ...
    render() {
        const logo = this.state.layoutColorMode === 'dark' ? 'assets/layout/images/logoofmine-white.png': 'assets/layout/images/logoofmine.png';
